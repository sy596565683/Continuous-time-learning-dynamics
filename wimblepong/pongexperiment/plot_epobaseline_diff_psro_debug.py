...
other_names = [
        'psro_entropy_test_(0.003)_4000',
        'psro_entropy_test_(0.01)_4000',
                # 'psro_entropy(0.0)',
                # 'psro_entropy(0.003)',
                # 'psro_entropy(0.01)',
                # 'psro_entropy(0.03)',
...
# base_path = '../data/psro_Meta_current_compare_baseline_epoch10_fpo_clip_entropy(0.1)_pong_2p/match_payoff_'
base_path = '../data/psro_4000_test_compare_baseline_epoch10_fpo_clip_entropy(0.1)_pong_2p/match_payoff_'
...
plt.grid(True)
plt.savefig("psro_4000_fpo(0_1)_current_result")
