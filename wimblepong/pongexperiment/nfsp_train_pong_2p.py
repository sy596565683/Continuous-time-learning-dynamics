from spinup import nfsp_tf1 as nfsp
import gym
import wimblepong
import argparse
...
parser.add_argument('--seed', '-s', type=int, default=300)
...
parser.add_argument('--exp_name', type=str, default='nfsp_entropy(0.03)_pong_2p')
...
nfsp(lambda: gym.make("WimblepongMultiplayer-v0"),
